    ...
    return (
        <>
            <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center bg-white mt-16 md:mt-32 px-4">
                <div className="w-full md:w-[650px] h-auto md:h-[478px] bg-btnBackground p-6 flex flex-col justify-start items-start text-left text-white">
                    ...
                    <div className="pl-4 md:pl-6">
                        <button className="bg-[#258992] text-white px-6 md:px-8 py-3 md:py-4 text-[14px] md:text-[16px] font-normal">
                            View collection
                        </button>
                    </div>
                </div>
            ...
            <div className="max-w-screen-xl mx-auto mt-32 px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="bg-[#F9F9F9] p-6 text-center">
                        <h3 className="text-[20px] font-normal text-btnColor flex items-center justify-center pt-5">
                            <FaTruck className="text-btnColor mb-2" />
                            Next day as standard
                        </h3>
                        <p className="text-[16px] font-normal text-btnColor  mt-4">
                    ...
                    <div className="bg-[#F9F9F9] p-6 text-center">
                        <h3 className="text-[20px] font-normal text-btnColor flex items-center justify-center pt-5">
                            <FaCheck className="text-btnColor mr-2" />
                            Made by true artisans
                        </h3>
                        <p className="text-[16px] font-normal text-btnColor mt-4 text-left">
                    ...
                    <div className="bg-[#F9F9F9] p-6 text-center">
                        <h3 className="text-[20px] font-normal text-btnColor flex items-center justify-center pt-5">
                            <IoFileTrayOutline className="text-btnColor mr-3" />
                            Unbeatable prices
                        </h3>
                        <p className="text-[16px] font-normal text-btnColor mt-4">
                    ...
                    <div className="bg-[#F9F9F9] p-6 text-center">
                        <h3 className="text-[20px] font-normal text-btnColor flex items-center justify-center pt-5">
                            <BiSolidLeaf className="text-btnColor mr-3" />
                            Recycled packaging
                        </h3>
                        <p className="text-[16px] font-normal text-btnColor mt-4">
